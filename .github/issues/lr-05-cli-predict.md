...
## 📝 Tarefas Técnicas
- [x] Criar `predict.py` na raiz.
- [x] Solicitar quilometragem via `input()` com validação de entradas não numéricas.
- [x] Exibir o preço formatado em moeda/número legível.
